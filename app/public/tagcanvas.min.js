...
(function () {
  ...
  function NewCanvas(w, h) {
    ...
    c.addEventListener("whell", preventScroll);
    c.addEventListener("scroll", preventScroll, false);
    c.addEventListener("mousewheel", preventScroll, false);
    c.addEventListener("touchmove", preventScroll, false);
    c.width = w;
    c.height = h;
    return c;
  }
